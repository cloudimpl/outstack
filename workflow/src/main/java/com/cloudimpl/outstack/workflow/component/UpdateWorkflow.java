 ...
 * @author nuwan
 */
public class UpdateWorkflow extends EntityCommandHandler<WorkflowEntity, WorkflowUpdateRequest, CommandResponse> {

    @Override
    protected CommandResponse execute(EntityContext<WorkflowEntity> context, WorkflowUpdateRequest command) {
        context.<WorkflowEntity>asRootContext()
