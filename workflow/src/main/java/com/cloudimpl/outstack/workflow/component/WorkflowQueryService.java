 ...
 * @author nuwan
 */
@CloudFunction(name = "WorkflowQueryService")
@Router(routerType = RouterType.ROUND_ROBIN)
public class WorkflowQueryService extends SpringQueryService<WorkflowEntity> {

    static {
        $$(WorkflowEntity.class);
    }

    public WorkflowQueryService(EventRepositoryFactory factory) {
        super(factory);
    }
}
