 ...
 * @author nuwan
 */
public class WorkflowUpdateRequest extends Command {

    private final String workflowId;
    private final String workId;
    private final WorkContext workContext;

    public WorkflowUpdateRequest(Builder builder) {
        super(builder);
        this.workflowId = builder.workflowId;
        this.workId = builder.workId;
        this.workContext = builder.context;
    }
    ...
    public static final class Builder extends Command.Builder {
        ...
        public WorkflowUpdateRequest build() {
            return new WorkflowUpdateRequest(this);
        }
