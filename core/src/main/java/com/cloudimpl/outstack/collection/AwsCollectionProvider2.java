 ...
 * @author nuwansa
 */
public class AwsCollectionProvider2 implements CollectionProvider2 {
  ...
  private AwsCollectionProvider2(String defaultTableName, AwsClientBuilder.EndpointConfiguration endpoint,
  ...
  private AwsCollectionProvider2(String defaultTableName, AmazonDynamoDB client) {
    this.client = null;
  ...
  public static AwsCollectionProvider2 localEmbedded(AmazonDynamoDB client, String table) {
    return new AwsCollectionProvider2(table, client);
  }

  public static AwsCollectionProvider2 local(String endpoint, String defaultTableName) {
    return AwsCollectionProvider2.builder()
  ...
  public static final class Builder {
    ...
    public AwsCollectionProvider2 build() {
      return new AwsCollectionProvider2(defaultTableName, endpoint, credentialProvider);
    }
  }
}
