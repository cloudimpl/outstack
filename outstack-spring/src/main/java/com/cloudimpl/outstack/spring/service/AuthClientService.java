 ...
 * @author nuwan
 */
public class AuthClientService extends SpringService<AuthClient>{
    static
    {
        $(CreateAuthClient.class);
        $(UpdateAuthClient.class);
    }
    public AuthClientService(EventRepositoryFactory factory) {
        super(factory);
    }
